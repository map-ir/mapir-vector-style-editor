          ...
          transformRequest: (url: string) => {
            if (url.startsWith('https://map.ir')) {
              ...
              return {
                ...
                headers: {
                  token:
                    'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsImp0aSI6ImMwMzJhYTQ4OGU2MTM5NzUxMzhjYzE1YmZkNDNiNTllNDYyYWZmZjI4MWViZWEzMTA2OWI0MzczMzJjYjE4ODE3MDYzOTAzNDk2YThjYmM3In0..oBzrLE69VcKXuD9UawHpbZvCyk_9kbg1NO53Gf6g_DkC9yv-mNU8HxjszCaQRUnZntPXCzLjlgzqIs5vgO95LPe-lS58QI3Yzx9NzmbtFkw45CLMdQBbQOuwXXo7VhABg_FHWAWnbcP_OigLKICJaOvngqLdFmgnLdyO2yUStNKvK513BzHB3FjUoNEVVXCmawZr1Bd3xaSaeOCuAyPCFxrCKdEBHApbw8yauJGtrsyHNtfb4Cl7VzRM2lghtXnURX9xxKs6gMZbGLbVnlffr8D0IAef_UM1ivET6HVk4CRcyR_-s3P7tNWeMEDgLHD_IGVXTodO_-xVJhhldHGkZw',
                  'x-api-key':
